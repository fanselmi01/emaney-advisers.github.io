...
function mostrarTextoCompleto() {
    ...
    // Ocultar el degradado
    document.querySelector('.degradado').style.display = 'none';
    // Ocultar "Leer más" y mostrar "Leer menos"
    document.getElementById('leer-mas').style.display = 'none';
    document.getElementById('leer-menos').style.display = 'inline';
}

function ocultarTextoCompleto() {
    // Restablecer la altura máxima del párrafo recortado
    document.getElementById('parrafo').style.maxHeight = '250px';
    // Mostrar el degradado
    document.querySelector('.degradado').style.display = 'block';
    // Ocultar "Leer menos" y mostrar "Leer más"
    document.getElementById('leer-menos').style.display = 'none';
